...
struct MovieData {
    private static let movies: [Movie] = [
        Movie(name: "Minions",
              year: 2015,
              genre: "animation",
    ...
    static let sortedMovies = MovieData.movies.sorted(by: {$0.genre < $1.genre})
    static let newestMovie = Movie(name: "Goodfellas", year: 1994, genre: "Horror", cast: ["Robert De Niro", "Joe Pesci", "Adam Jackson"], locations: ["Long Island","NY C"], posterImageName: "", description: "")
}
